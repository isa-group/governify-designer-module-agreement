...
import es.us.isa.governify.designer.modules.agreement.utils.TranslateUtil;
        ...
        if (currentFormat.equals("iagree") && desiredFormat.equals("opl")) {
            ...
            if (errorListener.hasErrors()) {
                ...
                for (IAgreeError error : errorListener.getErrors()) {
                    ...
                    appAnnot.setType(TypeEnum.error);
            ...
            appResponse.setStatus(StatusEnum.OK_PROBLEMS);
            appResponse.setMessage("Cannot convert from " + currentFormat + " to " + desiredFormat);
        }
        return appResponse;
    }
